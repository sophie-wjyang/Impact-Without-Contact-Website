...
<div class="page-wrapper">
    <!-- Preloader -->
    <div class="preloader style-three"><div class="icon"></div></div>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.html" title=""><img src="images/sticky-logo-3.png" alt="" title=""></a>
                </div>
                <!--Right Col-->
    ...
    <section class="banner-section style-two">
        <div class="banner-carousel love-carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 0, "autoHeight":false, "singleItem" : true, "autoplay": true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "1" } , "1024":{ "items" : "1" }}}'>
            ...
            <div class="slide-item">
                <div class="image-layer lazy-image" data-bg="url('images/main-slider/18.jpg')"></div>
            ...
            <!-- Slide Item -->
            <div class="slide-item">
                <div class="image-layer lazy-image" data-bg="url('images/main-slider/19.jpg')"></div>
            ...
            <!-- Slide Item -->
            <div class="slide-item">
                <div class="image-layer lazy-image" data-bg="url('images/main-slider/20.jpg')"></div>
    ...
    <!--About Section-->
    <section class="about-section style-seven">
    ...
    <!--How It Work Section-->
    <section class="how-it-works style-three">
    ...
    <section class="recent-donors-section">
        <div class="auto-container">
            <div class="sec-title centered">
                <div class="sub-title">Our Donros</div>
                <h2>Recent Donors</h2>
                <div class="text">Cupidatat non proident sunt</div>
            </div>
            <div class="love-carousel owl-theme owl-carousel" data-options='{"loop": false, "margin": 30, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 300, "responsive":{ "0" :{ "items": "1" }, "600" :{ "items" : "2" }, "768" :{ "items" : "3" } , "800":{ "items" : "3" }, "1024":{ "items" : "4" }}}'>
                <div class="slide-item">
                    <div class="donor-block">
                        <div class="inner-box">
                            <figure class="image"><img src="images/resource/donor-thumb-1.jpg" alt=""></figure>
                            <h4>Benjamin Zara</h4>
                ...
                <div class="slide-item">
                    <div class="donor-block">
                        <div class="inner-box">
                            <figure class="image"><img src="images/resource/donor-thumb-2.jpg" alt=""></figure>
                            <h4>Paul Wilson</h4>
                            <div class="donation-info">
                                <div class="title">Donation</div>
                ...
                <div class="slide-item">
                    <div class="donor-block">
                        <div class="inner-box">
                            <figure class="image"><img src="images/resource/donor-thumb-3.jpg" alt=""></figure>
                            <h4>Robert Hels</h4>
                            <div class="donation-info">
                                <div class="title">Donation</div>
                ...
                <div class="slide-item">
                    <div class="donor-block">
                        <div class="inner-box">
                            <figure class="image"><img src="images/resource/donor-thumb-4.jpg" alt=""></figure>
                            <h4>John Smith</h4>
                            <div class="donation-info">
                                <div class="title">Donation</div>
                        ...
                        <div class="row">                                    
                            ...
                            <div class="col-lg-12 form-group">
                                <select class="custom-select-box">
                                    <option>I Want to Donate for</option>
                                    <option>Educated Childrens</option>
                                    <option>Homeless Childrens</option>
                                    <option>Refugee Childrens</option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-12 form-group">
                                <span class="title">Donate Type</span>
                                <input type="radio" name="duration" id="weekly">
    ...
    <section class="call-to-action style-two">
        ...
        <!--Image Layer-->
        <div class="image-layer lazy-image" data-bg="url('images/background/call-to-action-2.jpg')"></div>
                                ...
                                <div class="cause-block-three style-two">
                                    <div class="inner-box clearfix">
                                        <div class="text-column">
                                            <div class="inner">
                                                <h3><a href="event-single.html">Raise Fund for Healthy Food</a></h3>
            ...
            <div class="row clearfix">
                ...
                <div class="news-block-three col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box wow fadeInRight" data-wow-delay="0ms">
                        <!--News Post-->
                        <div class="news-post">
                            <div class="post-thumb"><a href="blog-single.html"><img class="lazy-image" src="images/resource/image-spacer-for-validation.png" data-src="images/resource/post-thumb-3.jpg" alt=""></a></div>
                        ...
                        <!--News Post-->
                        <div class="news-post">
                            <div class="post-thumb"><a href="blog-single.html"><img class="lazy-image" src="images/resource/image-spacer-for-validation.png" data-src="images/resource/post-thumb-4.jpg" alt=""></a></div>
                            <div class="date"><span class="fa fa-calendar-alt"></span> Sep 20, 2019</div>
                            <h4><a href="blog-single.html">The Study and The Town that Changed the Health of a Generation</a></h4>
                        </div>
                        <!--News Post-->
                        <div class="news-post">
                            <div class="post-thumb"><a href="blog-single.html"><img class="lazy-image" src="images/resource/image-spacer-for-validation.png" data-src="images/resource/post-thumb-5.jpg" alt=""></a></div>
